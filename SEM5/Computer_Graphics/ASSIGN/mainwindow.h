...
//    void floodfillFunc(int x1, int y1,int k, QRgb q1, int r,int g,int b);
    ...
    void on_reflection1_clicked();
    void on_reflection2_clicked();
    void on_about_a_point_clicked();
    void on_set_point_clicked();
    void on_BoundaryMake_clicked();
    void drawBound();
    ...
    void on_ClipPolygon_clicked();
    void on_clipLine_clicked();
    void on_vertex1_clicked();
     void on_vertex2_clicked();
